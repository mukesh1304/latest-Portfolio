          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/amitshankhwar/blood-care-development"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://bloodcare-app.onrender.com"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>BloodCare - Role-Based Blood Bank System</h3>
              <p>
                Developed a secure role-based login system for a blood bank
                application, enabling distinct functionalities for donors,
                receivers, and admin roles.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/amitshankhwar/HungerEatsRestaurantApp.git"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://hungereatsrestaurantapp.onrender.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>HungerEats - Food Delivery Platform</h3>
              <p>
                Built an intuitive food ordering system streamlining the user
                journey from menu browsing to order placement with real-time
                tracking.
              </p>
            </div>
            <footer>
              ...
              <ul className="tech-list">
                {" "}
                <li>NextJs</li> <li>TypeScript</li> <li>MongoDB</li>
                <li>Stripe</li>
                <li>Shadcn UI</li>{" "}
              </ul>{" "}
            </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/amitshankhwar/Code-sync-MERN-app.git"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />{" "}
                ...
                <a
                  href="https://code-synced.onrender.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>CodeSync - Collaborative Coding Portal</h3>
              <p>
                Designed a real-time code collaboration platform with live
                preview, version control, and multi-user support for seamless
                peer coding.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/amitshankhwar/EduSolve-main.git"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
                ...
                <a
                  href="https://edusolve.vercel.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>EduSolve - Doubt Solving Platform</h3>
              <p>
                Created a collaborative Q&A platform for students to post doubts
                and get expert solutions using a streamlined ticket-based
                support flow using AI agents for efficient query resolution.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/amitshankhwar/Job-search-app.git"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
            ...
            <div className="body">
              <h3>JobConnect - Job Search Portal</h3>
              <p>
                Developed a job search web application that connects job seekers
                with recruiters, featuring advanced filtering, resume uploads,
                and role-based dashboards for seamless user experience.
              </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/amitshankhwar/book-store-app.git"
                  target="\_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
            ...
            <div className="body">
              <h3>BookBazaar - Online Bookstore Platform</h3>
              <p>
                Built a scalable and user-friendly online bookstore application
                enabling sellers to upload books with detailed descriptions,
                categorize them by genre, author, or language, and manage their
                listings. Buyers can browse curated collections, search by
                category or keyword, add books to personalized wishlists, and
                purchase with a secure checkout system.
              </p>
            </div>
